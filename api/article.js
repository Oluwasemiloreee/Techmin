...
module.exports = async function handler(req, res) {
  ...
  const subscribeCTA = `
        <div class="subscribe-cta">
          ...
          <p>Get practical tech tips and African tech news straight to your inbox. No spam, unsubscribe anytime.</p>
          <a href="/subscribe" class="subscribe-cta-btn">Subscribe to Techmin <i class="bi bi-arrow-right"></i></a>
        </div>
      `;
      ...
      <section class="article-reading">
        <div class="container narrow">
          ...
          <div class="article-share">
            ...
            <div>
              <a class="share-btn" href="https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(canonicalUrl)}"
                 target="_blank" rel="noopener" title="Share on LinkedIn" aria-label="Share on LinkedIn">
                <i class="bi bi-linkedin"></i><span>LinkedIn</span>
              </a>
              <a class="share-btn" href="https://twitter.com/intent/tweet?url=${encodeURIComponent(canonicalUrl)}&text=${encodeURIComponent(article.title)}"
                 target="_blank" rel="noopener" title="Share on X" aria-label="Share on X">
                <i class="bi bi-twitter-x"></i><span>X</span>
              </a>
              <a class="share-btn" href="https://wa.me/?text=${encodeURIComponent(article.title + ' — ' + canonicalUrl)}"
                 target="_blank" rel="noopener" title="Share on WhatsApp" aria-label="Share on WhatsApp">
                <i class="bi bi-whatsapp"></i><span>WhatsApp</span>
              </a>
              <button class="share-btn copy-link" title="Copy link" aria-label="Copy article link">
    ...
    document.querySelector('#article-root .copy-link')?.addEventListener('click', async (event) => {
      ...
      const showResult = (ok) => {
        btn.innerHTML = ok
          ...
          : '<i class="bi bi-x-lg"></i><span>Try again</span>';
      ...
      try {
        ...
        // (older mobile browsers, non-HTTPS previews, some in-app browsers).
        try {
